...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-violet-600/30 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-fuchsia-600/20 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--muted-foreground)]">Sign in to PromptDuel</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-[var(--muted-foreground)]">
          ...
          <Link to="/register" className="text-[var(--primary)] hover:text-violet-400 font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
